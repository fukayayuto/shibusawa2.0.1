...
<div id="wrapper"> 
  <!-- header// -->
  <header>
    <div id="logo"><a href="http://odekake-ashi.com/"><img src="{{ asset('/img/shared/logo.svg') }}" alt="謎解キ旅行社" /></div>
    <div id="global">
      <!--<ul id="sns">
    ...
    <div id="bodyHead">
      <div id="breadCrumbs">
        <ol itemscope="" itemtype="https://schema.org/BreadcrumbList">
          ...
          <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem"><a href="http://odekake-ashi.com/event/shibusawa/" itemprop="item"><span itemprop="name">渋沢栄一の真実</span></a>
